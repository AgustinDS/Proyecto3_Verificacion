...
./salida +UVM_VERBOSITY=UVM_HIGH +UVM_TESTNAME=test_01 +ntb_random_seed=1 > deleteme_log_0

# echo "[COMANDO] Escenario 1: Uso común del dispositivo" > deleteme_log_1
# for seed in {1..3}
# do
# 	./salida +UVM_VERBOSITY=UVM_HIGH +UVM_TESTNAME=test_01 +ntb_random_seed_automatic >> deleteme_log_1
...
# for seed in {1..5}
# do
# 	./salida +UVM_VERBOSITY=UVM_HIGH +UVM_TESTNAME=test_10 +ntb_random_seed_automatic >> deleteme_log_2
